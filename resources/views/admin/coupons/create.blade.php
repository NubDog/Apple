            ...
            <div class="form-container">
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group code-input-group">
                            <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" required placeholder="e.g., SUMMER2023">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <label class="radio-container">
                                <input type="radio" name="type" value="fixed" {{ old('type') == 'fixed' ? 'checked' : '' }} checked>
                                <span class="radio-custom"></span>
                                <span class="radio-label">Fixed Amount ($)</span>
                            </label>
                            <label class="radio-container">
                                <input type="radio" name="type" value="percent" {{ old('type') == 'percent' ? 'checked' : '' }}>
                                <span class="radio-custom"></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <span class="input-icon" id="valueIcon">$</span>
                        </div>
                        <small class="form-text" id="valueHelp">Amount to deduct from the order total</small>
                        @error('value')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            <input type="number" name="min_order_amount" id="min_order_amount" class="form-control @error('min_order_amount') is-invalid @enderror" value="{{ old('min_order_amount') }}" step="0.01" min="0">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="max_uses" id="max_uses" class="form-control @error('max_uses') is-invalid @enderror" value="{{ old('max_uses') }}" min="0">
                ...
                <div class="coupon-preview">
                    <div class="coupon-card">
                        <div class="coupon-content">
                            <div class="discount">
                                <span class="discount-value" id="previewValue">$10.00</span>
                                <span class="discount-label" id="previewType">OFF</span>
                            </div>
                            <div class="coupon-details">
                                <div class="coupon-code-display" id="previewCode">SUMMER2023</div>
                                <div class="coupon-expiry" id="previewExpiry">Valid until: No Expiry</div>
                            </div>
                        </div>
                        ...
                        <div class="coupon-restrictions">
                            <div class="restriction-item" id="previewMinimum">Minimum order: None</div>
                            <div class="restriction-item" id="previewUsage">Usage: Unlimited</div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updatePreview() {
            // Update code
            previewCode.textContent = codeInput.value || 'EXAMPLE';
